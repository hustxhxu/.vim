...
func SetComment()
	...
	call append(line(".")+3, "*   Author: xhxu")
	call append(line(".")+4, "*   Create: ".strftime("%Y-%m-%d %H:%M")) 
	call append(line(".")+5, "*   Email: xuxuanhong1@bigo.sg") 
...
func SetTitle()
	...
	elseif &filetype == 'python' 
		...
		call SetComment_sh()
		call setline(15,"import os, sys, logging")
		call setline(16,"_pwd=os.path.dirname(os.path.abspath(__file__)); _rep_name='recommend_algorithm'")
		call setline(17,"_rep_idx=_pwd.find(_rep_name)")
		call setline(18,"_rep_dir=os.path.join(_pwd[:_rep_idx], _rep_name)")
		call setline(19,"")
		call setline(20,"logging.basicConfig(filename='/dev/null', level=logging.DEBUG)")
		call setline(21,"logger = logging.getLogger(__name__)")
		call setline(22,"handler = logging.StreamHandler(sys.stdout)")
		call setline(23,"handler.setLevel(logging.DEBUG)")
		call setline(24,"formatter = logging.Formatter(fmt='[TIMELINE] %(levelname)s %(asctime)s %(message)s', datefmt='%Y-%m-%d_%H:%M:%S')")
		call setline(25,"handler.setFormatter(formatter)")
		call setline(26,"logger.addHandler(handler)")
		call setline(27,"")
