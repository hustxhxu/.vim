...
func SetTitle()
	...
	elseif &filetype == 'sh' 
		...
		call setline(17,"")
		call setline(18,"CWD=$(dirname $0) && _PWD=$(cd $CWD;pwd)")
		call setline(19,"")
	...
	elseif &filetype == 'python' 
		...
		call setline(16,"_pwd=os.path.dirname(os.path.abspath(__file__))")
		call setline(17,"")
		call setline(18,"logging.basicConfig(filename='/dev/null', level=logging.DEBUG)")
		call setline(19,"logger = logging.getLogger(__name__)")
		call setline(20,"handler = logging.StreamHandler(sys.stdout)")
		call setline(21,"handler.setLevel(logging.DEBUG)")
		call setline(22,"formatter = logging.Formatter(fmt='[TIMELINE] %(levelname)s %(asctime)s %(message)s', datefmt='%Y-%m-%d_%H:%M:%S')")
		call setline(23,"handler.setFormatter(formatter)")
		call setline(24,"logger.addHandler(handler)")
		call setline(25,"")
